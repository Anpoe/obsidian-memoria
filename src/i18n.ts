...
const zhCN: Dict = {
  ...
  "sidebar.section.toggle": "展开/收起分组",
  "sidebar.section.drag": "拖拽排序分组",
  "sidebar.search.add": "新建检索式",
  "sidebar.search.addTitle": "创建自定义检索式",
  "sidebar.search.editTitle": "编辑检索式",
  "sidebar.search.name": "名称",
  "sidebar.search.namePlaceholder": "例如：工作灵感",
  "sidebar.search.query": "检索式",
  "sidebar.search.queryPlaceholder": "例如：#工作 after:2026-01-01",
  "sidebar.search.queryHint": "支持关键词、-排除词、#标签、-#标签、after:、before: 和 date:。",
  "sidebar.search.nameRequired": "请先填写检索式名称",
  "sidebar.search.queryRequired": "请先填写检索式内容",
  "sidebar.search.save": "保存检索式",
  "sidebar.search.cancel": "取消",
  "sidebar.search.pin": "固定检索式",
  "sidebar.search.unpin": "取消固定检索式",
  "sidebar.search.pinnedNotice": "✓ 检索式已固定，下次打开 Memoria 时自动使用",
  "sidebar.search.unpinnedNotice": "已取消固定检索式",
  "sidebar.search.edit": "编辑检索式",
  "sidebar.search.delete": "删除检索式",
  "sidebar.search.deleteConfirm": "确定删除检索式“{name}”吗？",
  "sidebar.search.builder.field": "筛选字段",
  "sidebar.search.builder.operator": "条件",
  "sidebar.search.builder.detail": "详细选择",
  "sidebar.search.builder.chooseField": "选择字段",
  "sidebar.search.builder.chooseValue": "选择或填写",
  "sidebar.search.builder.addCondition": "添加检索条件",
  "sidebar.search.builder.removeCondition": "删除此条件",
  "sidebar.search.builder.field.tag": "标签",
  "sidebar.search.builder.field.text": "文本",
  "sidebar.search.builder.field.date": "日期",
  "sidebar.search.builder.field.type": "类型",
  "sidebar.search.builder.field.status": "状态",
  "sidebar.search.builder.field.source": "来源",
  "sidebar.search.builder.field.path": "路径",
  "sidebar.search.builder.field.metadata": "元数据",
  "sidebar.search.builder.operator.include": "包含",
  "sidebar.search.builder.operator.exclude": "排除",
  "sidebar.search.builder.operator.equals": "等于",
  "sidebar.search.builder.operator.after": "晚于或等于",
  "sidebar.search.builder.operator.before": "早于或等于",
  "sidebar.search.builder.value.image": "有图片",
  "sidebar.search.builder.value.link": "有链接",
  "sidebar.search.builder.value.text": "有文字",
  "sidebar.search.builder.value.noText": "无文字",
  "sidebar.search.builder.value.pinned": "已置顶",
  "sidebar.search.builder.value.starred": "已收藏",
  "sidebar.search.builder.value.todo": "有待办",
  "sidebar.search.builder.value.done": "有已完成待办",
  "sidebar.search.builder.value.hasTag": "有标签",
  "sidebar.search.builder.value.noTag": "无标签",
  "sidebar.search.builder.textPlaceholder": "输入要匹配的文字",
  "sidebar.search.builder.noOptions": "暂无可选项",
  "sidebar.search.builder.nameRequired": "请填写检索式名称",
  "sidebar.search.builder.conditionRequired": "请完整填写每一条检索条件",
  "sidebar.search.builder.matchCount": "匹配 {n} 条笔记",
  ...
  "notice.archiveFailed": "归档状态保存失败：{msg}",
  ...
  "empty.todo": "还没有待办",
  "empty.todoSub": "在笔记里写 `- [ ] 要做的事` 就能在这里看到；全部勾选完成后会从待办视图移除。",
  ...
  "settings.excludePinnedSearches.name": "检索式排除置顶筛选",
  "settings.excludePinnedSearches.desc": "开启后，置顶笔记不受自定义检索式条件限制；选中任何检索式时，置顶笔记都会保留显示。",
...
const enUS: Dict = {
  ...
  "sidebar.section.toggle": "Expand/collapse section",
  "sidebar.section.drag": "Drag to reorder section",
  "sidebar.search.add": "New search",
  "sidebar.search.addTitle": "Create custom search",
  "sidebar.search.editTitle": "Edit search",
  "sidebar.search.name": "Name",
  "sidebar.search.namePlaceholder": "e.g. Work ideas",
  "sidebar.search.query": "Search query",
  "sidebar.search.queryPlaceholder": "e.g. #work after:2026-01-01",
  "sidebar.search.queryHint": "Supports keywords, -excluded terms, #tags, -#tags, after:, before:, and date:.",
  "sidebar.search.nameRequired": "Enter a name for this search",
  "sidebar.search.queryRequired": "Enter a search query",
  "sidebar.search.save": "Save search",
  "sidebar.search.cancel": "Cancel",
  "sidebar.search.pin": "Pin search",
  "sidebar.search.unpin": "Unpin search",
  "sidebar.search.pinnedNotice": "✓ Search pinned; Memoria will use it next time",
  "sidebar.search.unpinnedNotice": "Search unpinned",
  "sidebar.search.edit": "Edit search",
  "sidebar.search.delete": "Delete search",
  "sidebar.search.deleteConfirm": "Delete search “{name}”?",
  "sidebar.search.builder.field": "Field",
  "sidebar.search.builder.operator": "Condition",
  "sidebar.search.builder.detail": "Details",
  "sidebar.search.builder.chooseField": "Choose field",
  "sidebar.search.builder.chooseValue": "Choose or enter",
  "sidebar.search.builder.addCondition": "Add condition",
  "sidebar.search.builder.removeCondition": "Remove condition",
  "sidebar.search.builder.field.tag": "Tag",
  "sidebar.search.builder.field.text": "Text",
  "sidebar.search.builder.field.date": "Date",
  "sidebar.search.builder.field.type": "Type",
  "sidebar.search.builder.field.status": "Status",
  "sidebar.search.builder.field.source": "Source",
  "sidebar.search.builder.field.path": "Path",
  "sidebar.search.builder.field.metadata": "Metadata",
  "sidebar.search.builder.operator.include": "Include",
  "sidebar.search.builder.operator.exclude": "Exclude",
  "sidebar.search.builder.operator.equals": "Equals",
  "sidebar.search.builder.operator.after": "On/after",
  "sidebar.search.builder.operator.before": "On/before",
  "sidebar.search.builder.value.image": "Has image",
  "sidebar.search.builder.value.link": "Has link",
  "sidebar.search.builder.value.text": "Has text",
  "sidebar.search.builder.value.noText": "No text",
  "sidebar.search.builder.value.pinned": "Pinned",
  "sidebar.search.builder.value.starred": "Starred",
  "sidebar.search.builder.value.todo": "Has open to-do",
  "sidebar.search.builder.value.done": "Has completed to-do",
  "sidebar.search.builder.value.hasTag": "Has a tag",
  "sidebar.search.builder.value.noTag": "No tag",
  "sidebar.search.builder.textPlaceholder": "Text to match",
  "sidebar.search.builder.noOptions": "No options available",
  "sidebar.search.builder.nameRequired": "Enter a name for this search",
  "sidebar.search.builder.conditionRequired": "Complete every search condition",
  "sidebar.search.builder.matchCount": "{n} matching memos",
  ...
  "notice.archiveFailed": "Failed to save archive state: {msg}",
  ...
  "empty.todoSub": "Add `- [ ] something` to a memo to see it here. A memo leaves the To-do view when all its tasks are completed.",
  ...
  "settings.excludePinnedSearches.name": "Exclude pinned notes from search filtering",
  "settings.excludePinnedSearches.desc": "When enabled, pinned notes bypass every custom-search condition and remain visible whenever a saved search is selected.",
